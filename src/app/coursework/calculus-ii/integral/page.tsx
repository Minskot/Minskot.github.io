...
export default function CalculusIIIntegralPage() {
    return (
        <section className="space-y-4">
            <CourseworkPdfTabs />
            <div className="flex items-center justify-between gap-4">
                <h2 className="text-xl font-bold text-black dark:text-white">多元函数积分学</h2>
                <a
                    href="/coursework/calculus-ii-integral.pdf"
                    target="_blank"
            ...
            <div className="rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 bg-white dark:bg-black">
                <iframe
                    src="/coursework/calculus-ii-integral.pdf#view=FitH"
                    title="多元函数积分学 PDF"
